...
DarknetMessage_Base::DarknetMessage_Base(const char *name, int kind) :
        cPacket(name, kind) {
...
DarknetMessage_Base::DarknetMessage_Base(const DarknetMessage_Base& other) :
        cPacket(other) {
    copy(other);
}
...
DarknetMessage_Base& DarknetMessage_Base::operator=(
        const DarknetMessage_Base& other) {
    if (this == &other)
        return *this;
...
DarknetMessageDescriptor::DarknetMessageDescriptor() :
        cClassDescriptor("DarknetMessage", "cPacket") {
}
...
const char *DarknetMessageDescriptor::getProperty(
        const char *propertyname) const {
...
unsigned int DarknetMessageDescriptor::getFieldTypeFlags(void *object,
        int field) const {
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
    ...
    static unsigned int fieldTypeFlags[] = { FD_ISEDITABLE, FD_ISEDITABLE,
            FD_ISEDITABLE, FD_ISCOMPOUND, FD_ISEDITABLE, };
    return (field >= 0 && field < 5) ? fieldTypeFlags[field] : 0;
}

const char *DarknetMessageDescriptor::getFieldName(void *object,
        int field) const {
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    static const char *fieldNames[] = { "destNodeID", "srcNodeID", "TTL",
            "type", "requestMessageID", };
    return (field >= 0 && field < 5) ? fieldNames[field] : NULL;
}

int DarknetMessageDescriptor::findField(void *object,
        const char *fieldName) const {
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    int base = basedesc ? basedesc->getFieldCount(object) : 0;
    if (fieldName[0] == 'd' && strcmp(fieldName, "destNodeID") == 0)
        return base + 0;
    if (fieldName[0] == 's' && strcmp(fieldName, "srcNodeID") == 0)
        return base + 1;
    if (fieldName[0] == 'T' && strcmp(fieldName, "TTL") == 0)
        return base + 2;
    if (fieldName[0] == 't' && strcmp(fieldName, "type") == 0)
        return base + 3;
    if (fieldName[0] == 'r' && strcmp(fieldName, "requestMessageID") == 0)
        return base + 4;
    return basedesc ? basedesc->findField(object, fieldName) : -1;
}

const char *DarknetMessageDescriptor::getFieldTypeString(void *object,
        int field) const {
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    static const char *fieldTypeStrings[] = { "string", "string", "int",
            "DarknetMessageType", "long", };
    return (field >= 0 && field < 5) ? fieldTypeStrings[field] : NULL;
}

const char *DarknetMessageDescriptor::getFieldProperty(void *object, int field,
        const char *propertyname) const {
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
int DarknetMessageDescriptor::getArraySize(void *object, int field) const {
    ...
    DarknetMessage_Base *pp = (DarknetMessage_Base *) object;
    (void) pp;
    switch (field) {
    default:
        return 0;
...
std::string DarknetMessageDescriptor::getFieldAsString(void *object, int field,
        int i) const {
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    switch (field) {
    case 0:
        return oppstring2string(pp->getDestNodeID());
    case 1:
        return oppstring2string(pp->getSrcNodeID());
    case 2:
        return long2string(pp->getTTL());
    case 3: {
    ...
    case 4:
        return long2string(pp->getRequestMessageID());
    default:
        return "";
    }
}

bool DarknetMessageDescriptor::setFieldAsString(void *object, int field, int i,
        const char *value) const {
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    switch (field) {
    case 0:
        pp->setDestNodeID((value));
        return true;
    case 1:
        pp->setSrcNodeID((value));
        return true;
    case 2:
        pp->setTTL(string2long(value));
        return true;
    case 4:
        pp->setRequestMessageID(string2long(value));
        return true;
    default:
        return false;
    }
...
const char *DarknetMessageDescriptor::getFieldStructName(void *object,
        int field) const {
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    static const char *fieldStructNames[] = { NULL, NULL, NULL,
            "DarknetMessageType", NULL, };
    return (field >= 0 && field < 5) ? fieldStructNames[field] : NULL;
}

void *DarknetMessageDescriptor::getFieldStructPointer(void *object, int field,
        int i) const {
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
