...
#ifndef __INET_IUDPSOCKET_H
#define __INET_IUDPSOCKET_H
...
public:
     ...
     */
    virtual void setOutputGate(cGate *toUdp) {
        gateToUdp = toUdp;
    }
     ...
     */
    virtual void setTypeOfService(unsigned char tos);
     ...
     * socket option).
     */
    virtual void setMulticastLoop(bool value);
     ...
     * InterfaceTable.
     */
    virtual void setMulticastOutputInterface(int interfaceId);
     ...
     * that address.
     */
    virtual void joinMulticastGroup(const IPvXAddress& multicastAddr,
            int interfaceId = -1);
     ...
     */
    virtual void joinLocalMulticastGroups();
     ...
     */
    virtual void leaveMulticastGroup(const IPvXAddress& multicastAddr);

    /**
     * Causes the socket to leave each multicast groups that are registered with
     * any of the interfaces.
     */
    virtual void leaveLocalMulticastGroups();

    /**
     * Sends a data packet to the given address and port.
     */
    virtual void sendTo(cPacket *msg, IPvXAddress destAddr, int destPort);
